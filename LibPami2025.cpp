...
#else
#define PAMI_JUMPER_NB_L 0
#define PAMI_JUMPER_NB_H 0
#endif
...
#define PAMI_BASE_CHANNEL_MOTEURS 4
...
LibPami2025::LibPami2025() :
  ...
  moteur(PAMI_MOTEUR_IN1, PAMI_MOTEUR_IN2, PAMI_MOTEUR_IN3, PAMI_MOTEUR_IN4),
  gpio(gpioPinList,4),

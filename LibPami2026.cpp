...
#define PAMI_JUMPER_NB_L  1
#define PAMI_JUMPER_NB_M  2
#define PAMI_JUMPER_NB_H  3
#define PAMI_JUMPER_TEAM  4
...
#define PAMI_MOTEURS2_IN1 36
#define PAMI_MOTEURS2_IN2 37
#define PAMI_MOTEURS2_IN3 38
#define PAMI_MOTEURS2_IN4 39

#define PAMI_BASE_CHANNEL_MOTEURS1 4
#define PAMI_BASE_CHANNEL_MOTEURS2 8
...
LibPami2026Basic::LibPami2026Basic() :
  ...
  moteur(PAMI_PIN_GPIO_5, PAMI_PIN_GPIO_6),
...
LibPami2026Ninja::LibPami2026Ninja() :
  afficheur(PAMI_AFF1637_CLK,PAMI_AFF1637_DATA),
  jumper(PAMI_JUMPER_TEAM, jumpersPinList, 3),
  moteur1(PAMI_MOTEURS1_IN1, PAMI_MOTEURS1_IN2, PAMI_MOTEURS1_IN3, PAMI_MOTEURS1_IN4,PAMI_BASE_CHANNEL_MOTEURS1),
  moteur2(PAMI_MOTEURS2_IN1, PAMI_MOTEURS2_IN2, PAMI_MOTEURS2_IN3, PAMI_MOTEURS2_IN4,PAMI_BASE_CHANNEL_MOTEURS2),

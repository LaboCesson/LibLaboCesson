...
#ifndef _LIB_TELEMETRE_H_
#define _LIB_TELEMETRE_H_
...
class LibVl53lox
{
  public: 
    ...
    /// \details Permet de valider l'utilisation du capteur laser
    void begin(void);
  ...
  private:
    ...
    unsigned short m_distanceMax;

    VL53L0X_RangingMeasurementData_t m_measure;

    Adafruit_VL53L0X lox; ///< Librairie de gestion d'un VL53LOX
